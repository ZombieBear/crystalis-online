...
package net.k3rnel.server.battle_old.impl;
...
import net.k3rnel.server.battle_old.DataService;
import net.k3rnel.server.battle_old.Monster;
import net.k3rnel.server.battle_old.MonsterEvolution;
import net.k3rnel.server.battle_old.MonsterSpecies;
import net.k3rnel.server.battle_old.MonsterEvolution.EvolutionTypes;
